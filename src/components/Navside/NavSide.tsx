  ...
  return (
    <NavSideBar>
      <nav>
        ...
        <ul>
          <li className="PoopinsFont">
            {' '}
            <img src={DashLogo} className="DashImg" />{' '}
            <Link to="/home">Dashboard</Link>{' '}
          </li>
          <li className="PoopinsFont">
            <img src={Predictions} className="DashImg" />{' '}
            <Link to="/predicoes">Predições</Link>
          </li>
          <li className="PoopinsFont">
            {' '}
            <img src={Products} className="DashImg" />{' '}
